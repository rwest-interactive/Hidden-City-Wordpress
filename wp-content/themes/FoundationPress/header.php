		...
		<div class="inner-wrap">
			...
			<nav class="tab-bar show-for-small-only">
				...
				<section class="tab-bar-section">
					...
					<svg width="89" height="34" class="logo">
								<a href="<?php echo home_url(); ?>"><image xlink:href="images/hidden-city-logo.svg" src="images/hidden-city-logo.png" width="89" height="36" alt="<?php echo esc_attr( get_bloginfo('name', 'display') ); ?> logo "/></a>
								</svg>
